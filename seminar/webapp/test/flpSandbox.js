					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Seminario COL 2023",
									"targetURL": "#seminar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"seminar-display": {
								"semanticObject": "seminar",
								"action": "display",
								"description": "Seminario COL 2023",
								"title": "Seminario COL 2023",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=seminar",
									"url": sap.ui.require.toUrl("seminar")
								}
							}
						}
					}
